...
async function setupScene() {	
	...
	let vertSource = await loadNetworkResourceAsText('../../shared/resources/shaders/verts/gouraudTexture300.vert');
	let fragSource = await loadNetworkResourceAsText('../../shared/resources/shaders/frags/gouraudTexture300.frag');
    ...
    image.src = '../../shared/resources/textures/hd_power_t.png';
}
...
function initializeMyObject(vertSource, fragSource, objData) {
	...
	myDrawable.uniformLocations = myShader.getUniformLocations(['uModelViewMatrix', 'uProjectionMatrix', 'uNormalMatrix', 'uSampler',
																'uCameraPosition','uAmbient', 'uSpecular', 'uShininess']);
