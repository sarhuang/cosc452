...
async function setupScene() {	
	...
	let vertSource = await loadNetworkResourceAsText('../../shared/resources/shaders/verts/basicTexture300.vert');
	let fragSource = await loadNetworkResourceAsText('../../shared/resources/shaders/frags/basicTexture300.frag');
