...
var texture = null;	//this is my diffuse texture
...
async function setupScene() {	
	let objData = await loadNetworkResourceAsText('../shared/resources/models/cubeTextured.obj');
	let vertSource = await loadNetworkResourceAsText('../shared/resources/shaders/verts/midterm300.vert');
	let fragSource = await loadNetworkResourceAsText('../shared/resources/shaders/frags/midterm300.frag');
	initializeMyObject(vertSource, fragSource, objData);


	//texture = loadTexture('../shared/resources/textures/toybox/hd_wood.png');
	normalTexture = loadTexture('../shared/resources/textures/toybox/toy_box_normal.png');
	texture = loadTexture('../shared/resources/textures/toybox/toy_box_diffuse.png');
}
...
function initializeMyObject(vertSource, fragSource, objData) {
	...
	myDrawable.uniformLocations = myShader.getUniformLocations(['uModelViewMatrix', 'uProjectionMatrix', 'uNormalMatrix', 'uSampler', 'uSamplerNormal']);
